...
# vista DashboardCharacterization:  Imprime todos los objetos del modelo datalink (id, nombre y link)
def dashboardCharacterization(request):
    ...
    return render(request, "CharacterizationApp/dashboardCharacterization.html", {'datalinks':datalinks})
